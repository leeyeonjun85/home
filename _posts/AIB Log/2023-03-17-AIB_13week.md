...
conda activate 'practice'
  # Git bash 에서 가상환경 실행
source C:/ProgramData/Anaconda3/Scripts/activate n412
# 가상환경 종료
conda deactivate
...
pip install git+https://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@github.com/aib-contents/pytest-submit-plugin
