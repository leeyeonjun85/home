...
- 모델 해석
  ...
  ![image-right]({{ site.url }}{{ site.baseurl }}/assets/images/aib/section2/04_3target.png){: .align-center width="70%"}
  ...
  ![image-right]({{ site.url }}{{ site.baseurl }}/assets/images/aib/section2/04_feature_bld1.png){: .align-center width="70%"}

  ![image-right]({{ site.url }}{{ site.baseurl }}/assets/images/aib/section2/04_feature_bld2.png){: .align-center width="70%"}
  ...
  ![image-right]({{ site.url }}{{ site.baseurl }}/assets/images/aib/section2/04_pdp_jobin673.png){: .align-center width="70%"}
